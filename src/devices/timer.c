...
timer_interrupt (struct intr_frame *args UNUSED)
{
  ...
  while (e != NULL && e != list_end (&sleeping_list))
    {
      struct timer_sleeper *sleeper = list_entry (e, struct timer_sleeper, elem);
      struct list_elem *next = list_next (e);

      // Check if it's time to wake up this sleeper
